...
export const Header: React.FC = () => {
  ...
  return (
    <header className={`h-16 px-6 border-b z-40 transition-colors duration-300 flex items-center justify-between ${
      isLockdownMode 
      ...
      <div className="flex items-center space-x-4">
        <div className="flex items-center space-x-3">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-blue-600 via-sky-500 to-indigo-600 flex items-center justify-center shadow-lg shadow-sky-500/25 border border-sky-400/30">
      ...
      <div className="flex items-center space-x-3">
        {/* Real-time Clock */}
        <div className="hidden md:flex flex-col items-end pr-3 border-r border-slate-800 font-mono">
          <span className="text-sm font-bold text-sky-400 tracking-wider">{currentTime}</span>
          ...
          {showSimMenu && (
            <div className="absolute right-0 mt-2 w-64 rounded-xl bg-slate-900 border border-slate-700 shadow-2xl p-2 z-50 text-xs">
              ...
              <button 
                ...
                className="w-full text-left px-2 py-2 rounded hover:bg-red-950/60 text-red-300 flex items-center space-x-2"
              >
              ...
              <button 
                ...
                className="w-full text-left px-2 py-2 rounded hover:bg-amber-950/60 text-amber-300 flex items-center space-x-2"
              >
              ...
              <button 
                ...
                className="w-full text-left px-2 py-2 rounded hover:bg-slate-800 text-slate-300 flex items-center space-x-2"
              >
              ...
              <button 
                ...
                className="w-full text-left px-2 py-2 rounded hover:bg-purple-950/60 text-purple-300 flex items-center space-x-2 border-t border-slate-800 mt-1"
              >
